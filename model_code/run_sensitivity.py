...
sa_parameters = {
    # Consider varying the number of agents (decrease or increase?)
...
# Run experiment.
# Consider increasing number of iterations
...
results.save(exp_name='SA_Exp_Saltelli', exp_id=sa_parameters['out_name'], path='sensitivity_data', display=True)
...
# Consider adding other output metrics such as NOD etc.
